        ...
        ZStack {
            ...
            VStack {
                ...
                ZStack {
                    ...
                    RankPointBarView(nowRankPoint: userDefaultsModel.currentRankPoint, nextRankPoint: userDefaultsModel.untilNextRank).frame(width: 250)
                    HStack {
                        Spacer()
                    ...
                    }.frame(alignment: .bottom).padding(.trailing, 30).padding(.bottom, 70)
                }.offset(y:-23)
